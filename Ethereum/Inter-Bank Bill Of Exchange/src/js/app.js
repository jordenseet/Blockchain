App = {
    ...
    web3 = new Web3(App.web3Provider);
      ...
      initContract: function() {
        $.getJSON('LetterOfCredit', function(data) {
          ...
          return App.setBillOfExchange(value); //need retrieve value from html
      ...
      setBillOfExchange: function (value){
        App.contracts.LetterOfCredit.deployed().then(function(instance) {
          locInstance = instance;
        
          return locInstance.setBillOfExchangePrice.call(value);
        });
      }
